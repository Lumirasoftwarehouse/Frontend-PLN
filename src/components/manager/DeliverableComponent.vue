          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="mb-3">
                ...
                <input type="text" class="form-control" :id="'deliverable' + index" placeholder="enter deliverable" v-model="deliverable.deliverable" />
              </div>
            </div>
          </div>
          <div class="row">
          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="mb-3">
                ...
                <textarea class="form-control" :id="'notes' + index" rows="3" v-model="deliverable.notes" placeholder="enter notes"></textarea>
              </div>
            </div>
          </div>
        </div>
